...
* [Import and install the package](assets/generate-multiple-pdf-from-xml). This package contains html page which allows you to drop the template and data files.
