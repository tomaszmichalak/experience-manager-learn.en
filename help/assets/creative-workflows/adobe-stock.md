...
activity: use
version: 6.4, 6.5
redirect-from: https://docs.adobe.com/content/help/en/experience-manager-learn/assets/creative-cloud/stock-assets-feature-video-use.html
---
...
To set up Adobe Stock with AEM Assets, review the [Set up Adobe Stock with AEM Assets](./set-up-adobe-stock.md) instructions.
...
* [Set up Adobe Stock with AEM Assets](./set-up-adobe-stock.md)
